...
data "aws_rds_orderable_db_instance" "test" {
  ...
  // performance insights not available on db.*.micro
  preferred_db_instance_classes = ["db.m3.medium", "db.m3.large", "db.m4.large"]
}
...
data "aws_rds_orderable_db_instance" "test" {
  ...
  // performance insights not available with db.t3.micro
  preferred_db_instance_classes = ["db.m3.medium", "db.m3.large", "db.m4.large"]
}
